...
export const appCanvasClass = "bg-[#f4f5f7] dark:bg-neutral-950";
...
export const sidebarSectionLabelClass =
  "mb-1 px-2 text-[10px] font-semibold uppercase tracking-widest text-slate-400 dark:text-neutral-500";
...
export const sidebarItemIdleClass =
  "text-slate-600 hover:bg-slate-50 hover:text-slate-900 dark:text-neutral-400 dark:hover:bg-neutral-800/50 dark:hover:text-neutral-100";
...
export const topbarSectionLabelClass =
  "text-[10px] font-semibold uppercase leading-none tracking-widest text-slate-400 dark:text-neutral-500";

export const topbarTitleClass =
  "truncate text-[15px] font-bold leading-tight tracking-[-0.02em] text-slate-900 dark:text-neutral-100";

export const topbarAccentBarClass = "h-7 w-0.5 shrink-0 rounded-full bg-[#008f68]";

export const topbarActionsGroupClass =
  "flex h-9 shrink-0 items-center gap-0.5 rounded-lg border border-slate-200/60 bg-slate-100/80 p-0.5 dark:border-neutral-800 dark:bg-neutral-900/80";
