...
export function CustomerTimelinePanel({
  ...
  return (
    <aside className="motion-safe:animate-in motion-safe:fade-in-0 motion-safe:slide-in-from-right-8 flex h-full min-h-0 w-full min-w-0 shrink-0 flex-col border-l border-slate-200/80 bg-white antialiased shadow-2xl motion-safe:duration-300 motion-safe:ease-out sm:min-w-[420px] dark:border-neutral-800 dark:bg-neutral-950">
      <div className="motion-safe:animate-in motion-safe:fade-in-0 motion-safe:slide-in-from-top-2 relative flex shrink-0 items-center justify-between gap-3 border-b border-slate-200/70 bg-white px-4 py-2.5 motion-safe:delay-75 motion-safe:duration-300 sm:px-5 dark:border-neutral-800 dark:bg-neutral-950">
        <div className="flex min-w-0 items-center gap-3.5 pr-8">
          ...
          <div className="min-w-0 pt-0.5">
            ...
            <div className="mt-0.5 flex items-center gap-1.5 text-[11px] font-medium text-slate-500 dark:text-neutral-400">
        ...
        <button
          ...
          className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full text-slate-400 transition-all hover:bg-slate-100 hover:text-slate-700 active:scale-95 sm:right-4 dark:hover:bg-neutral-800 dark:hover:text-neutral-200"
        >
      ...
      <div className="motion-safe:animate-in motion-safe:fade-in-0 motion-safe:slide-in-from-bottom-2 min-h-0 flex-1 overflow-y-auto overscroll-contain bg-[#f8fafc] dark:bg-neutral-950 px-1 py-1 motion-safe:delay-150 motion-safe:duration-300">
        <CustomerTimeline
