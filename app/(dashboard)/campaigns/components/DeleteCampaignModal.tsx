          ...
          {hasTickets ? (
            ...
            >
              ...
              <p className="mt-3 text-[13px] font-semibold text-amber-950 dark:text-amber-100">
                Cannot delete this campaign
              </p>
              <p className="mt-2 text-[13px] leading-relaxed text-amber-900/90 dark:text-amber-200/90">
                It has <span className="font-semibold">{tickets}</span> linked
                activit{tickets === 1 ? "y" : "ies"}. Deactivate the campaign
                instead.
              </p>
            ...
            <p className="text-justify text-[13px] leading-relaxed text-slate-600 dark:text-slate-400">
              You are about to remove this campaign from the system. Historical
              reporting data may be affected.
            </p>
          )}
        </div>
