    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="gap-0 overflow-hidden rounded-2xl p-0 shadow-2xl sm:max-w-sm">
        <DialogHeader className="border-b border-slate-100 px-5 py-4 dark:border-neutral-800">
          <DialogTitle className="flex items-center gap-2 text-[15px] font-semibold text-slate-900 dark:text-neutral-50">
        ...
        <div className="bg-[#f4f5f7] px-5 py-4 dark:bg-neutral-900/60">
          <div className="overflow-hidden rounded-xl border border-slate-200/80 bg-white px-4 py-3.5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] dark:border-neutral-800 dark:bg-neutral-950">
            <p className="text-[12px] leading-relaxed text-slate-600 dark:text-neutral-400">
