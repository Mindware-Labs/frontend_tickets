...
const inputClass =
  "h-9 w-full rounded-lg border border-transparent bg-slate-50 px-2.5 text-xs text-slate-800 placeholder:text-slate-400 hover:border-slate-300 focus:border-[#008f68] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#008f68]/20 dark:bg-slate-800 dark:text-slate-100";
      ...
      <DialogContent className="gap-0 overflow-hidden rounded-2xl p-0 shadow-2xl sm:max-w-sm">
        ...
        <form onSubmit={handleSubmit}>
          <div className="bg-[#f4f5f7] px-5 py-4 dark:bg-slate-900/60">
            <div className="overflow-hidden rounded-xl border border-slate-200/80 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.06)] dark:border-slate-800 dark:bg-slate-950">
