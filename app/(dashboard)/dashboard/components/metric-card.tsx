...
> = {
  emerald: {
    tile: "border-slate-200/80 bg-white text-slate-900 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-100",
    icon: "text-[#008f68]",
  ...
  slate: {
    ...
    trend: "text-slate-600 dark:text-neutral-400",
    accent: "bg-slate-400",
  },
};
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 text-lg font-bold leading-none tabular-nums text-slate-900 sm:text-xl dark:text-neutral-100">
          {metric.value}
        </p>
      </div>
      <div className="hidden min-w-0 max-w-[42%] flex-col gap-0 text-right text-[10px] leading-snug sm:flex">
        <span className="line-clamp-2 text-slate-500 dark:text-neutral-400">
          {metric.detail}
        </span>
      ...
      <div className="min-w-0 flex-1 flex-col gap-0 text-[10px] leading-snug sm:hidden">
        <span className="line-clamp-1 text-slate-500 dark:text-neutral-400">
          {metric.detail}
        </span>
        <span className={cn("line-clamp-1 font-semibold", tone.trend)}>
          {metric.trend}
