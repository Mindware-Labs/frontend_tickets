...
export function DeleteLandlordModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="border-b border-slate-100 px-5 py-5 text-center sm:px-6 sm:text-center dark:border-slate-800">
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="space-y-1.5">
              <DialogTitle className="text-[16px] font-semibold leading-tight text-slate-950 dark:text-slate-50">
                Delete landlord
              </DialogTitle>
              <DialogDescription className="mx-auto max-w-[300px] text-[13px] leading-relaxed text-slate-500 dark:text-slate-400">
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-slate-100 bg-slate-50/80 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 dark:border-slate-800 dark:bg-slate-900/60">
          <Button
            type="button"
            variant="outline"
