    ...
    <button
      ...
      className={cn(
        ...
        isActive
          ...
          : "border-blue-100/80 hover:border-blue-200 hover:shadow-md",
      )}
    >
      <div
        className="flex items-center gap-2.5 px-3 py-2 border-b border-slate-50"
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <p className="text-[12px] font-bold text-slate-800">Source Call</p>
            <span className="text-[10px] font-mono text-slate-400">#{callId}</span>
          </div>
        ...
        <span
          className={cn(
            ...
            isActive ? "text-blue-700 bg-blue-50 border-blue-200" : "text-slate-600 bg-slate-50 border-slate-200",
          )}
        >
      ...
      <div className="flex flex-wrap items-center gap-1.5 px-3 py-2 bg-slate-50/50">
        <span
        ...
        {call?.agent?.name && (
          <span className="text-[10px] font-medium text-slate-600 truncate max-w-[8rem]">
            {call.agent.name}
          </span>
        )}
        {call?.disposition && (
