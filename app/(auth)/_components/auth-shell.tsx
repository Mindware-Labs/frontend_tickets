...
const SHELL_CSS = `
  ...
  .auth-title-h1 { color: #0f172a; }
  .auth-title-p  { color: #64748b; }
  .auth-badge {
    background: #ffffff;
    border: 1px solid rgba(15,23,42,0.08);
    color: #475569;
  }
  .auth-badge-strong { color: #0f172a; }
  .auth-powered { color: #94a3b8; }
`;
...
export function AuthShell({
  ...
  return (
    <div
      className="light auth-shell-root"
      style={{
        minHeight: "100vh",
        width: "100%",
        position: "relative",
    ...
    >
      ...
      >
        ...
        >
          ...
          Restricted to{" "}
          <strong className="auth-badge-strong" style={{ fontWeight: 700 }}>CCQUEST</strong>
          {" "}&amp;{" "}
          <strong className="auth-badge-strong" style={{ fontWeight: 700 }}>RIG HUT</strong>
          {" "}personnel only.
        </div>
        <div className="auth-powered" style={{ fontSize: 11 }}>
